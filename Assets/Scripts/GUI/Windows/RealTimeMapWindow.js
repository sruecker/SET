...
function DoWindow(windowID : int) {
	...
	GUI.BeginGroup(Rect(0, newHeight - 1 , __mapWidth, __lowerMenuHeight));
	...
	if(GUILayout.Button(GUIContent(addLocationTexture, "Add position"), realTimeMapStyle, GUILayout.Width(__lowerButtonSize))) {
		addView();
	}
	GUILayout.Space(buttonSpacing);
	
	if(GUILayout.Button(GUIContent(removeLocationTexture, "Remove position"), realTimeMapStyle, GUILayout.Width(__lowerButtonSize)  )) {
		removeView();
	}
	GUILayout.Space(buttonSpacing);
